...
from GE2E.utils.audio import AudioProcessor
import re
import json
import fsspec
import torch
...
use_cuda = False
# config
config_dict = read_json("GE2E/saved_models/config.json")
# print(config_dict)
...
speaker_encoder.load_checkpoint("GE2E/saved_models/best_model.pth.tar", eval=True, use_cuda=use_cuda)
